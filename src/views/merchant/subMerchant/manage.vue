...
<!--          <el-button link type="primary" icon="Edit" @click="handleOperation(scope.row, 'edit')">维护</el-button>-->
        </template>
      </el-table-column>
    </el-table>
...
import { postSubMerchantApi } from "@/api/merchant/platMerchant";
...
const handleOperation = (row, type) => {
  router.push({
    path: '/platform/merchant/subMerchant/detail',
    query: {
